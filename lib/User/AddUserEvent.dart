...
class _AddUserEventState extends State<AddUserEvent> {
  ...
  VALUES ("${_nameController.text}", "${_dateController.text}", "${_locationController.text}", "${_descriptionController.text}", "${_statusController.text}", '${user?.uid}')''');
